<template>
	<el-dialog v-model="dialogFormVisible" :title="`添加文章`" :destroy-on-close="true" width="620px" draggable>
...
// const articleForm = ref<Article.ReqAddArticleParams>();
const protable = inject("proTable") as any;
